...
public class Scrolllist : MonoBehaviour {
	...
	void Awake() {
		...
		if (instance5 == null)
			instance5 = this;
		// If one already exists, it's because it came from another level.
...
//____________________________________________________________
	...
	public void getScrollEntrys()
	{
		...
		for (int i=0; i<HSController.Instance.onlineHighscore.Length-1; i++) {
            ...
            ScorePanel.transform.SetParent(ScrollContain.transform, false);
			...
			//first position is gold
			if (j == 1) {

                ScoreName.color = new Color32(255, 223, 0, 255);
                ScorePoints.color = new Color32(255, 223, 0, 255);
                ScorePosition.color = new Color32(255, 223, 0, 255);
            }
            //second position is silver
            if (j == 2) {
                ScoreName.color = new Color32(192, 192, 192,255);
                ScorePoints.color = new Color32(192, 192, 192, 255);
                ScorePosition.color = new Color32(192, 192, 192, 255);
            }
            //third position is bronze
            if (j == 3)
            {
                
                ScoreName.color = new Color32(205, 127, 50, 255);
                ScorePoints.color = new Color32(205, 127, 50, 255);
                ScorePosition.color = new Color32(205, 127, 50, 255);
            }
